...
if __name__ == "__main__":
    ...
    about = {}
    with open(os.path.join(src_dir, "vivarium_spatial", "__about__.py")) as f:
        exec(f.read(), about)
    ...
    cluster_requirements = ["vivarium_cluster_tools>=2.1.0"]
    ...
    setup(
        ...
        zip_safe=False,
        use_scm_version={
            "write_to": "src/vivarium_spatial/_version.py",
        ...
        entry_points="""
            [console_scripts]
            make_artifacts=vivarium_spatial.tools.cli:make_artifacts
        """,
    )
