...
from vivarium_spatial.constants import data_keys, metadata
from vivarium_spatial.tools.app_logging import add_logging_sink, decode_status
from vivarium_spatial.utilities import sanitize_location
...
def build_single_location_artifact(
    ...
    from vivarium_spatial.data import builder
